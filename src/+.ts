      ...
      subcommands: [
        {
          ...
          insertValue:
            "\b\b\b\b\b\b\b\bflutter build appbundle --obfuscate --split-debug-info=build/app/outputs/symbols --bundle-sksl-path sksl/flutter_android.sksl.json --dart-define=DART_WEB_RECAPTCHA_SITE_KEY=$WEB_RECAPTCHA_SITE_KEY_STG --dart-define=DART_IOS_FIREBASE_APP_ID=$IOS_FIREBASE_APP_ID --dart-define=DART_ENVIRONMENT=stg --dart-define=DART_GOOGLE_REVERSED_CLIENT_ID=$GOOGLE_REVERSED_CLIENT_ID_STG --dart-define=DART_BACKGROUND_GEOLOCATION_LICENSE=$BACKGROUND_GEOLOCATION_LICENSE --dart-define=DART_BACKGROUND_GEOLOCATION_FIREBASE_LICENSE=$BACKGROUND_GEOLOCATION_FIREBASE_LICENSE --dart-define=DART_MAPBOX_ACCESS_TOKEN=$MAPBOX_ACCESS_TOKEN --dart-define=DART_MAPBOX_STYLE_URL=$MAPBOX_STYLE_URL\n",
        },
        {
          name: ["ios", "i"],
          ...
          subcommands: [
            {
              ...
              insertValue:
                "\b\b\b\b\b\b\b\bcp web/prod.firebase-config.js web/firebase-config.js\ncp lib/generated/prod.firebase_options.dart lib/generated/firebase_options.dart\ncp lib/core/domain/prod.secrets.dart lib/core/domain/secrets.dart\nflutter build web --web-renderer canvaskit --dart-define=DART_WEB_RECAPTCHA_SITE_KEY=$WEB_RECAPTCHA_SITE_KEY_PROD --dart-define=DART_ENVIRONMENT=prod --dart-define=DART_MAPBOX_ACCESS_TOKEN=$MAPBOX_ACCESS_TOKEN --dart-define=DART_MAPBOX_STYLE_URL=$MAPBOX_STYLE_URL\n",
              options: [
                {
                  name: ["--deploy", "-d"],
            ...
            },
            {
              ...
              insertValue:
                "\b\b\b\b\b\b\b\bcp web/stg.firebase-config.js web/firebase-config.js\ncp lib/generated/stg.firebase_options.dart lib/generated/firebase_options.dart\ncp lib/core/domain/stg.secrets.dart lib/core/domain/secrets.dart\nflutter build web --web-renderer canvaskit --dart-define=DART_WEB_RECAPTCHA_SITE_KEY=$WEB_RECAPTCHA_SITE_KEY_STG --dart-define=DART_ENVIRONMENT=stg --dart-define=DART_MAPBOX_ACCESS_TOKEN=$MAPBOX_ACCESS_TOKEN --dart-define=DART_MAPBOX_STYLE_URL=$MAPBOX_STYLE_URL\n",
              options: [
                {
                  name: ["--deploy", "-d"],
